...
router.post("/update-wallet-transfer", async (req: Request, res: Response) => {
  try {
    const {
      oldPersonId,
      newPersonId,
...
router.post("/update-multiple-wallets", async (req: Request, res: Response) => {
  try {
...
router.delete("/remove-transaction", async (req: Request, res: Response) => {
  try {
