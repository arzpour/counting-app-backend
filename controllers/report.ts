...
// //         { fullName: { $regex: personName, $options: "i" } },
// //       ],
// //     });
...
// //         amount: trans.amount,
// //         description: trans.description || trans.reason || `تراکنش ${trans.type}`,
// //       });
// //     });
...
// //       const dealDate = deal.saleDate || deal.purchaseDate || deal.createdAt?.toISOString() || "";
...
// //   } catch (error) {
// //     console.error("Error in getPersonReportData:", error);
// //     throw error;
// //   }
// // };
...
//         { partnerPersonId: personId },
//       ],
//       // transactionDate: { $gte: startDatee, $lt: endDatee },
//       createdAt: { $gte: startDatee, $lt: endDatee },
//     }).lean();

//     console.log("🚀 ~ getPersonReportData ~ transactions:", transactions);
